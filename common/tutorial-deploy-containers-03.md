...
1. Make changes to your app and test locally. (This step and the two that follow are explained on [Create a container - Python](../python/tutorial-create-containers.md).)
