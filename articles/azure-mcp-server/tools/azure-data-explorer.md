...
The Azure MCP Server allows you to manage Azure Data Explorer resources using natural language prompts. You can list clusters, view databases, and query data with natural language. You can also use specific KQL queries for targeted responses.
