...
2. **Start exploring**: Ask your AI assistant questions about your storage accounts or request operations. Try prompts like:
...
3. **Learn more**: Review the [Azure Storage tools reference](../tools/azure-storage.md) for all available capabilities and detailed parameter information.
