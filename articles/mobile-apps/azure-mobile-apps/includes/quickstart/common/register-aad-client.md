...
1. Select the app registration you created earlier for your backend service.  If you don't see the app registration, make sure that you added the **access_as_user** scope.
   
   ![Native App Registration](~/mobile-apps/azure-mobile-apps/media/quickstart/common/register-native-app.png)

1. Under **Select permissions**, select **access_as_user**, and then select **Add permissions**.
1. Select **Authentication** > **Mobile and desktop applications**.
1. Check the box next to `https://login.microsoftonline.com/common/oauth2/nativeclient`.  
1. Select **Add URI**, then add `http://localhost` in the field for extra URIs.
1. Select **Save** at the bottom of the page.
1. Select **Overview**.  Make a note of the **Application (client) ID** as you will need it later.
