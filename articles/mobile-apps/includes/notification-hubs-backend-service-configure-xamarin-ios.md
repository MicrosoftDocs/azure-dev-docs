...
1. Select **General** > **Empty Class**, enter *DeviceInstallationService.cs* for the **Name**, then click **New** adding the following implementation.
    ...
    > [!NOTE]
    > This class provides a unique ID (using the [UIDevice.IdentifierForVendor](/dotnet/api/uikit.uidevice.identifierforvendor) value) and the notification hub registration payload.
