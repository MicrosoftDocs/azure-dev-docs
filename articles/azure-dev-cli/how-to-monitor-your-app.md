...
You can use any of the [Azure Developer CLI template](azure-dev-cli-overview#list-of-azd-templates) for this tutorial. We'll use the [Todo Application with Node.js and Azure Cosmo DB API for MongoDB](https://github.com/azure-samples/todo-nodejs-mongo). 
