...
There are several [AI app templates](/azure/developer/ai/intelligent-app-templates.md?pivots=python) featuring complete end-to-end solutions available for each programming language. One of the most popular templates the enterprise chat sample using RAG:
