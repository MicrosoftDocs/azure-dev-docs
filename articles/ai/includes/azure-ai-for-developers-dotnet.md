...
There are several [AI app templates](/azure/ai/intelligent-app-templates?pivots=dotnet) featuring complete end-to-end solutions available for each programming language. One of the most popular templates the enterprise chat sample using RAG:
