---
title: Get started with the chat with your data sample for JavaScript
...
# Get started with the chat with your data sample for JavaScript
...
* [Sample repository on GitHub](https://github.com/Azure-Samples/azure-search-openai-javascript)
