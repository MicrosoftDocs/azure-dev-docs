...
|Name|Description|
|---------------------------------------|--|
|[Azure Functions: Add Cosmos DB for MongoDB API integration](/azure/developer/javascript/tutorial/vscode-function-app-http-trigger/tutorial-vscode-serverless-node-database-integration)|Fixed connection pooling.|
