...
|[View deployed files in App or Functions services](./how-to/deploy-web-app.md#view-files-in-azure-hosted-environment)|Quick and simple methods to view your deployed files in the Azure portal or VSCode. |
