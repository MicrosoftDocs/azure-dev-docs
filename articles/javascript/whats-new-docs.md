...
|Name|Description|
|---------------------------------------|--|
|[Azure SDK: Use Azure SDKs for JavaScript and TypeScript](core/use-azure-sdk.md)|To programmatically access your Azure services, use the Azure SDKs for JavaScript. Typically, these SDKs are scoped with the @azure npm package scope published by azure-sdk. Learn how to [provide authentication credentials](core/use-azure-sdk.md#provide-authentication-credentials), [page through asynchronous results](core/use-azure-sdk.md#asynchronous-paging-of-results), [wait for long running asynchronous tasks](core/use-azure-sdk.md#long-running-operations).|
