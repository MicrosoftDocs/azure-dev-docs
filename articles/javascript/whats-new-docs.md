...
|Name|Description|
|---------------------------------------|--|
|GraphQL|Samples and procedures updated to latest frameworks:<br>* [Deploy a GraphQL API as an Azure Function](how-to/with-web-app/graphql/azure-function-hello-world?tabs=visualstudiocode)<br>* [Deploy a GraphQL API for CRUD mutations as an Azure Function](how-to/with-web-app/graphql/azure-function-crud-mutation?tabs=visualstudiocode) <br>* [Build and deploy a GraphQL static web app to Azure](how-to/with-web-app/graphql/static-web-app-graphql/introduction)|
