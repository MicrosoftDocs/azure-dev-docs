...
### How to customize DefaultAzureCredential chained credential
...
| Scenario | Options  |
|--|--|
| [Specify user-assigned managed identity](#customize-for-user-assigned-managed-identity) | [DefaultAzureCredentialClientIdOptions](/javascript/api/%40azure/identity/defaultazurecredentialclientidoptions) |
...
To diagnose an unexpected issue or to understand what a chained credential is doing, [enable logging](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/core#logging) in your app. You can this with either of the methods below:
