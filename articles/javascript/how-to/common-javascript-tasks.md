...
|GraphQL Azure Function with TypeScript showing basic Hello world functionality.|[Sample code](https://github.com/azure-samples/js-e2e-azure-function-graphql-hello)|
|Static web app with React client and Azure Function, both with shared TypeScript models demonstrating a Trivia game, with data held in Cosmos DB SQL API.|[Sample code](https://github.com/azure-samples/js-e2e-graphql-cosmosdb-static-web-app)|
