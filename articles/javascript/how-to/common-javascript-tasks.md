...
|Azure Function app with MongoDB|[Tutorial](../tutorial/vscode-function-app-http-trigger/tutorial-vscode-serverless-node-install?tabs=bash) - [Sample code](https://github.com/Azure-Samples/js-e2e-azure-function-mongodb)|
