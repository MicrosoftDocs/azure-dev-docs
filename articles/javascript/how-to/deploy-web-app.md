...
|[(Preview) Static Web apps](/azure/static-web-apps/)|Static front-end, Pre-render, JAM-stack, Static front-end with server APIs|Deploy with code-to-cloud workflow to host your **static client app and serverless APIs** with automated geo-distribution. This simple service abstracts away much of the deployment and configuration of the web server, allowing you to focus on the features that matter to a client application.<br><br>[**Quickstart**: Building your first static site with Azure Static Web Apps](/azure/static-web-apps/getting-started?tabs=vanilla-javascript) |
