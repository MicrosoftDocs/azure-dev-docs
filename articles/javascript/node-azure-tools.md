...
ms.custom:
  - devx-track-js, devx-track-azurecli, linux-related-content, devx-track-ts
...
- [Configure your JavaScript develop environment for Azure](core/configure-local-development-environment.md)
- [Manage GitHub repositories for JavaScript development in Visual Studio Code](how-to/with-visual-studio-code/clone-github-repository.md)
