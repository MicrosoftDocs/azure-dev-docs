...
**Applies to:** :heavy_check_mark: Any resource that is supported by the [AzureRM](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs) or [AzAPI](https://learn.microsoft.com/en-us/azure/templates/) provider.
...
### Azure Portal
1. Under **Azure Services**, select **Virtual machines**. If you do not see **Virtual machines**, search for it in the search bar above.
1. In the **Virtual machines** page, select **Create**, which will provide a dropdown. Select from there **Azure virtual machine**.
