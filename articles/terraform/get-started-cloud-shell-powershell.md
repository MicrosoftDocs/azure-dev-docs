...
Verify the current Azure subscription using one of the following methods:
...
1. If you want to authenticate using either a different Microsoft account or Azure subscription, this rest of this section shows you how.

#### [PowerShell](#tab/verify-current-sub-azcli)
