...
Follow the article to create a deprovisioned Ubuntu image with Nginx installed.
...
> [!NOTE]
> For the purposes of this article, in the Packer image, a command is run to install Nginx. You can also run your own script while creating.
...
The following commands delete the resources created in this article:
