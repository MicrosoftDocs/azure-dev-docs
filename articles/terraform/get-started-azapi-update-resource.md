...
Run [az eventhubs namespace network-rule list](/cli/azure/eventhubs/namespace#az-eventhubs-namespace-network-rule-list) to display the Event Hubs Namespace network rules.
