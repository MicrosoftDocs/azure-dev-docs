---
title: Get Started - Install Terraform in Windows with Azure PowerShell
description: Learn how to configure Terraform in Windows with Azure PowerShell
...
adobe-target: true
# Customer intent: As a Windows user new to Terraform and Azure, I want install Terraform in Windows using Azure PowerShell.
---

# Get Started: Install Terraform in Windows with Azure PowerShell
