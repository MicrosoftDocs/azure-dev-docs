...
1. Add a workflow file into the new folder. The `azd` starter template provides a [sample GitHub Actions workflow file](https://github.com/Azure-Samples/azd-starter-bicep) and [sample Azure DevOps Pipelines file](https://github.com/Azure-Samples/azd-starter-bicep) for each platform. You can copy these files into your project and modify them as needed.
