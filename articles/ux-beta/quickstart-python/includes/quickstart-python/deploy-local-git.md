...
[!INCLUDE [CLI deploy configure](<./deploy-local-instructions-azcli-configure.md>)]

Retrieve the deployment credentials for your application.  These will be needed for Git to authenticate to Azure when you push code to Azure in a later step.

[!INCLUDE [CLI deploy retrieve credentials](<./deploy-local-instructions-azcli-retrieve.md>)]
