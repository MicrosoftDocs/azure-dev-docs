...
| [!INCLUDE [A screenshot showing creating the pollsdb database in the Azure Cloud Shell](<./includes/django-postgresql-webapp/create-postgres-service-azure-portal-8.md>)] | :::image type="content" source="./media/django-postgresql-webapp/portal-launch-item.png" lightbox="./media/django-postgresql-webapp/portal-launch-item.png" alt-text="A screenshot showing how to allow access the Azure Cloud Shell." :::  |
