...
| [!INCLUDE [Azure portal - create new resource](<./includes/django-postgresql-webapp/create-postgres-service-vscode-4.md>)] | :::image type="content" source="./media/django-postgresql-webapp/create-postgres-service-vscode-4a-240px.png" alt-text="Create a new Resource in the Azure portal." lightbox="./media/django-postgresql-webapp/create-postgres-service-vscode-4a.png"::: :::image type="content" source="./media/e2e-python-django-app-postgresql/create-postgresql-db/vscode-create-postgresql-db-4b-240.png" alt-text="Create a new Resource in the Azure portal." lightbox="./media/e2e-python-django-app-postgresql/create-postgresql-db/vscode-create-postgresql-db-4b.png"::: |
