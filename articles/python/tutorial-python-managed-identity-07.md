...
|:----------------|-----------:|
| [!INCLUDE [Remove resource group Azure portal 1](<./includes/python-web-app-managed-identity/remove-resource-group-azure-portal-1.md>)] | :::image type="content" source="./media/python-web-app-managed-identity/remove-resource-group-azure-portal-1-240px.png" lightbox="./media/python-web-app-managed-identity/remove-resource-group-azure-portal-1.png" alt-text="A screenshot showing how to find resource group in the Azure portal." ::: |
| [!INCLUDE [Remove resource group Azure portal 2](<./includes/python-web-app-managed-identity/remove-resource-group-azure-portal-2.md>)] | :::image type="content" source="./media/python-web-app-managed-identity/remove-resource-group-azure-portal-2-240px.png" lightbox="./media/python-web-app-managed-identity/remove-resource-group-azure-portal-2.png" alt-text="A screenshot showing how to delete a resource group in the Azure portal." ::: |
| [!INCLUDE [Remove resource group Azure portal 3](<./includes/python-web-app-managed-identity/remove-resource-group-azure-portal-3.md>)] | |
...
| Instructions    | Screenshot |
|:----------------|-----------:|
| [!INCLUDE [Remove resource group Visual Studio Code 1](<./includes/python-web-app-managed-identity/remove-resource-group-visual-studio-code-1.md>)] | :::image type="content" source="./media/python-web-app-managed-identity/remove-resource-group-visual-studio-code-1-240px.png" lightbox="./media/python-web-app-managed-identity/remove-resource-group-visual-studio-code-1.png" alt-text="A screenshot showing how to delete a resource group in Visual Studio Code." ::: |

### [Azure CLI](#tab/azure-cli)

Azure CLI commands can be run in the [Azure Cloud Shell](https://shell.azure.com) or on a workstation with the [Azure CLI installed](/cli/azure/install-azure-cli).

[!INCLUDE [Clean up resources CLI](<./includes/python-web-app-managed-identity/clean-up-resources-cli.md>)]
