...
The script calls the [WebSiteManagementClient.web_apps.sync_repository](/azure/developer/#azure-mgmt-web-v2019-08-01-operations-webappsoperations-sync-repository) method to trigger a pull from the web app. If you push subsequent code changes to your repository, you can redeploy your code by invoking this API or by using other Azure tooling like the Azure CLI or Azure portal.
