...
\* Not Python-specific examples, but can be used to understand concepts that can be used with [Azure IoT Hub libraries for Python](/python/api/overview/azure/iot).
