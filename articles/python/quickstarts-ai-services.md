---
title: Get started with Foundry Tools for Python apps on Azure
...
Foundry Tools are cloud-based artificial intelligence (AI) services that help developers build cognitive intelligence into applications without needing direct AI or data science skills or knowledge. You can use ready-made Foundry Tools for computer vision and image processing, language analysis and translation, speech, decision-making, search, and Azure OpenAI in your Python applications.
...
1. On the hub page, select a service to go to its documentation landing page. For example, for [Azure Vision in Foundry Tools](/azure/ai-services/computer-vision/).
...
1. In the documentation, look for **Quickstarts** in the table of contents. For example, in the Image Analysis documentation, under Quickstarts, there's an [Image Analysis quickstart](/azure/ai-services/computer-vision/quickstarts-sdk/image-analysis-client-library?pivots=programming-language-python).
...
- [Python samples for Azure AI Search](/azure/search/samples-python)
