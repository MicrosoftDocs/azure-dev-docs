...
|[Azure SDK for OpenAI LangChain.js](https://github.com/langchain-ai/langchainjs/tree/main/libs/langchain-azure-openai)|The GitHub source version of the Azure SDK for OpenAI LangChain.js client library for JavaScript provides integration to Azure for LangChain integrations. It can connect to Azure OpenAI resource.|
|[Azure SDK for OpenAI LangChain.js releases](https://www.npmjs.com/package/@langchain/azure-openai?activeTab=versions)|Links to all Azure SDK for OpenAI LangChain.js library packages.|
|[@langchain/azure-openai](https://www.npmjs.com/package/@langchain/azure-openai)|The npm version of the Azure SDK for OpenAI LangChain.js client library for JavaScript.|
