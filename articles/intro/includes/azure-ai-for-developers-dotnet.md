...
|[Build GPT-automated customer support](https://aka.ms/acsaisampleapp)| This sample uses [Azure Communication Services](https://aka.ms/acsdocs) along with RAG, Azure AI Services and Azure Open AI to build a GPT powered customer support system that uses chat, calling and Email. [Demo video](https://aka.ms/acs-mech) |
