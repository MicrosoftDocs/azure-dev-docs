...
- [Azure Red Hat OpenShift](/azure/openshift/intro-openshift), which provides highly available, fully managed OpenShift clusters on-demand. OpenShift delivers added-value features to complement Kubernetes, making it a turnkey container platform that delivers significantly improved developer and operator experience.
...
- [Microsoft Build of OpenJDK](https://www.microsoft.com/openjdk) for Java 11 or 17 - the [base container images](/java/openjdk/containers) for which are supplied and maintained by Microsoft.
