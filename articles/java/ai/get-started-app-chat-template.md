---
title: Get started with the chat with your data sample for Java
...
# Get started with the chat with your data sample for Java
...
* [Sample repository on GitHub](https://github.com/Azure-Samples/azure-search-openai-demo-java)
