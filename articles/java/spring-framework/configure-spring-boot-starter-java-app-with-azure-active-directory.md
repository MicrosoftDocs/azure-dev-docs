---
title: Develop a Spring web app which supports sign-in by Azure AD account
description: Develop a Spring web app which supports sign-in by Azure AD account
...
# Develop a Spring web app which supports sign-in by Azure AD account

This article shows you how to develop a Spring web app which supports sign-in by [Azure AD account](/azure/active-directory/fundamentals/active-directory-whatis#terminology). After finishing all steps in this article, the web app will redirect to Azure AD sign-in page when been accessed anonymously. Here is an screenshot of Azure AD sign-in page:
