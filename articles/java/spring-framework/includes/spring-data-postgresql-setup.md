...
> [!IMPORTANT]
> When setting <YOUR_POSTGRESQL_AD_NON_ADMIN_USERNAME>, the username must already exist in your Azure AD tenant or you'll be unable to create an Azure AD user in your database.
