> [!NOTE]
> If you're using Spring Boot 4.0.x, set the `spring-cloud-azure-dependencies` version to `7.4.0`.
> 
> If you're using Spring Boot 3.5.x, set the `spring-cloud-azure-dependencies` version to `6.5.0`.
>
