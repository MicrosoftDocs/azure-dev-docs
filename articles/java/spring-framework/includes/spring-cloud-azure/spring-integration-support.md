...
See [azure-spring-boot-samples](https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloud-azure_5.0.0/eventhubs/spring-cloud-azure-starter-integration-eventhubs/eventhubs-integration) for more details.
...
See [azure-spring-boot-samples](https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloud-azure_5.0.0/servicebus/spring-cloud-azure-starter-integration-servicebus) for more details.
...
See [azure-spring-boot-samples](https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloud-azure_5.0.0/storage/spring-cloud-azure-starter-integration-storage-queue) for more details.
