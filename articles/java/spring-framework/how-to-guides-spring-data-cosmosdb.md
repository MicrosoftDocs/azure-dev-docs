...
The [Entity](https://github.com/Azure/azure-sdk-for-java/tree/spring-cloud-azure_4.3.0/sdk/cosmos/azure-spring-data-cosmos#define-an-entity) and [Repository](https://github.com/Azure/azure-sdk-for-java/blob/azure-spring-data-cosmos_3.9.0/sdk/cosmos/azure-spring-data-cosmos#create-repositories) definition is similar as above. You can put different database entities into different packages.
...
Beta versions built from the `master` branch are available. See the [instructions](https://github.com/Azure/azure-sdk-for-java/blob/spring-cloud-azure_4.3.0/CONTRIBUTING.md#dev-feed) to use the beta version packages.
