...
- [How to use the Spring Data Gremlin Starter with the Azure Cosmos DB SQL API](/azure/developer/java/spring-framework/configure-spring-data-gremlin-java-app-with-cosmos-db)
