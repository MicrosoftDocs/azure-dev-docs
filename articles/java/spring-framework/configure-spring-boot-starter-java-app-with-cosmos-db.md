...
> [!NOTE]
> To connect using Microsoft Entra ID, refer to the [Spring Boot Starter for Microsoft Entra ID developer's guid](spring-boot-starter-for-azure-active-directory-developer-guide?tabs=SpringCloudAzure4x).
