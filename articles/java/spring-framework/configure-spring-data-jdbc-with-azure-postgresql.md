...
```bash
curl https://start.spring.io/starter.tgz -d dependencies=web,data-jdbc,postgresql,azure-support -d baseDir=azure-database-workshop -d bootVersion=2.7.4 -d javaVersion=1.8 | tar -xzvf -
```
