...
description: Learn how to use Spring Data R2DBC with Azure Database for PostgreSQL to build a scalable, fully reactive Spring Boot application. Get started.
ms.author: karler
ms.reviewer: seal
ms.date: 08/19/2025
author: KarlErickson
...
This article shows how to use [Spring Data R2DBC](https://spring.io/projects/spring-data-r2dbc) with [Azure Database for PostgreSQL](/azure/postgresql/) to build a scalable, fully reactive Spring Boot application that stores and retrieves information. The sample uses the R2DBC implementation for PostgreSQL from the [r2dbc-postgresql](https://github.com/pgjdbc/r2dbc-postgresql) repository on GitHub.
...
In this article, you code a sample application. If you want to go faster, this application is already coded and available at [https://github.com/Azure-Samples/quickstart-spring-data-r2dbc-postgresql](https://github.com/Azure-Samples/quickstart-spring-data-r2dbc-postgresql).
...
The first thing you create is a managed PostgreSQL server with an admin user.

> [!NOTE]
> For more information about creating PostgreSQL servers, see [Create an Azure Database for PostgreSQL server by using the Azure portal](/azure/postgresql/quickstart-create-server-database-portal).
...
> [!NOTE]
> For more information about creating PostgreSQL users, see [Create users in Azure Database for PostgreSQL](/azure/PostgreSQL/flexible-server/how-to-create-users).
...
> [!WARNING]
> For security reasons, Azure Database for PostgreSQL requires SSL connections. Add the `spring.r2dbc.properties.sslMode=REQUIRE` configuration property. Otherwise, the R2DBC PostgreSQL driver tries to connect using an insecure connection, which fails.
...
Next, add the Java code that uses R2DBC to store and retrieve data from your PostgreSQL server.
...
Congratulations! You created a fully reactive Spring Boot application that uses R2DBC to store and retrieve data from Azure Database for PostgreSQL.
