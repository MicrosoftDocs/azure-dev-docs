...
1. To verify application is running, open a browser and go to `http://localhost:8080/albums`. The page returns a list of the JSON objects.
...
## Puash image to an Azure Container Registry
...
1. In the  **Azure Explorer** view, expand the **Azure node**, right-click **Container Registries**, and then click **Create in Azure Portal**.
...
1. Navigate to your project on the left-hand **Project** tab and click the **Dockerfile** to open.

1. Click the Azure icon in the line 1 and select "Push Image to Azure Container Registry" to continue.
...
1. When the **Create Container Apps Environment** page is displayed, specify the following information and click **OK**.
...
1. Select the container apps environment you have created the previous step, and right-click **Create > Container App** in Azure Explorer.
...
1. Specify the following information.
   ...
   * **Environment**: Specifies the ner Apps Environment you want to use.
...
1. Navigate to your project on the left-hand Project tab, and open the file *Dockerfile*.

 :::image type="content" source="media/create-container-apps-intellij/OpenDockerfile.png" alt-text="Open the Dockerfile.":::  


1. In the *Dockerfile*, click the Azure icon in the line 1 and select "Deploy Image to Container App".
 :::image type="content" source="media/create-container-apps-intellij/DeployImage.png" alt-text="Deploy Image to ACA.":::  

1. When the **Deploy Image to Azure Container Apps** page is displayed, Specify the following information and click **Run**.
   ...
   * **Ingress**:  Enable ingress for applications that need an HTTP or TCP endpoint. Select **Enable**.
...
1. Once this deployment process finishes, Azure Toolkit for IntelliJ will display a notification. Select Browse to open the deployed app in a browser.
...
1. Right-click the Azure Container Apps service you'd like to delete and then select **Delete**.
