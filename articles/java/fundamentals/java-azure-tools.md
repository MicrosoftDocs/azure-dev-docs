...
Java developers on Azure and Azure Stack can build and run production Java 8 and 11 applications. For more information about the supported JDKs available for use when developing on Azure, see <https://aka.ms/azure-jdks>.
