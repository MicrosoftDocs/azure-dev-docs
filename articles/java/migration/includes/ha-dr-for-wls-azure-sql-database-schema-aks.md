...
Enter the following query to create schema.
...
1. Schema for sample application.
...
You are done with the article **Quickstart: Create a single database - Azure SQL Database**.
