...
* Load balancing is a fundamental requirement. For information on the Liberty side of load balancing, see [WebSphere Application Server Liberty collective architecture](https://www.ibm.com/docs/was-liberty/core?topic=collectives-collective-architecture).
