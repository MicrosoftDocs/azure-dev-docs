...
1. After you select the button, the Copilot chat window with Agent Mode opens automatically.
     ...
     :::image type="content" source="../media/migrate-github-copilot-app-modernization-for-java/java-deploy-to-azure-chat-visual-studio-code.png" lightbox="../media/migrate-github-copilot-app-modernization-for-java/java-deploy-to-azure-chat-visual-studio-code.png" alt-text="Screenshot of Visual Studio Code that shows the Copilot chat window as opened automatically by the task.":::
