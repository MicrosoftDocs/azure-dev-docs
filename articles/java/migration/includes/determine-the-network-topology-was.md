...
* Load balancing is a fundamental requirement. The following reference covers the WAS side of load balancing: [WebSphere Application Server Network Deployment load-balanced clustering](https://www.ibm.com/docs/en/mci/7.6.2?topic=haas-websphere-application-server-network-deployment-load-balanced-clustering).
