...
When it comes to development, enterprises often have strict processes and controls, which is where custom skills come in. For more information, see [Quickstart: create and apply your own skills for GitHub Copilot app modernization](migrate-github-copilot-app-modernization-for-java-quickstart-create-and-apply-your-own-task.md)
