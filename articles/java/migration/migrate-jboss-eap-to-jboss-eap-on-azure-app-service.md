...
* **Server-to-server clustering**: As of March 15th, 2022 support for clustered deployments of JBoss EAP is supported in Public Preview.This means  applications which use stateful session beans, distributed transactions, and similar features that require instance-to-instance communication or high availability can now be deployed to App Service without removing such features. For more information see the [release announcement](https://techcommunity.microsoft.com/t5/apps-on-azure-blog/clustering-support-for-jboss-eap-on-azure-app-service-public/ba-p/3252898) and the [configuration guide](https://docs.microsoft.com/azure/app-service/configure-language-java?pivots=platform-linux#clustering-in-jboss-eap).
