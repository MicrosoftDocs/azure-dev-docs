...
- [Migrate Java apps to Azure using GitHub Copilot app modernization in Coding Agent Custom Agent](migrate-github-copilot-app-modernization-for-java-coding-agent-custom-agent.md)
