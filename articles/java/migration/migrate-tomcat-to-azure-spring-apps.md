...
1. Replace Tomcat Realms with [Spring Security](https://docs.spring.io/spring-security/reference/index.html#servlet-filters-review). Consider using Microsoft Entra ID for authorization management via the [Spring Cloud Azure support for Microsoft Entra ID](../spring-framework/spring-cloud-azure-overview.md#azure-active-directory).
