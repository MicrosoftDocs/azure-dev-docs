...
:::image type="content" source="./media/migrate-github-copilot-app-modernization-for-java/appmod-oracle-pgsql-report.png" lightbox="./media/migrate-github-copilot-app-modernization-for-java/appmod-oracle-pgsql-report.png" alt-text="Screenshot of Visual Studio Code showing the GitHub Copilot app modernization assessment report.":::
