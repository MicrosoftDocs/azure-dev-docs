...
1. It takes a while to finish the profile creation (it could take up to an hour). When the **Profile Creation Complete** pane appears, select **Launch the First steps console**. Then select **Finish**.
