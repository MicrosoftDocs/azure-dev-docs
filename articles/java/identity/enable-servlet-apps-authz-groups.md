---
title: Enable your Java Servlet web app to sign in users and restrict access to pages using security groups and groups claims with the Microsoft identity platform
...
The [sample code snippets](https://github.com/Azure-Samples/ms-identity-msal-java-samples/tree/main/3.%20Java%20Servlet%20Web%20App%20Tutorial/3-Authorization-II/groups) are available in GitHub as runnable Java files.
...
![Scenario](./media/identity-authorization-servlets/identity19.png)
...
![Experience](./media/identity-authorization-servlets/identity20.png)
