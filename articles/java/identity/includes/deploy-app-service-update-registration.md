...
Because the redirect URI changes to your deployed Web App to Azure App Service, you also need to change the redirect URI in your Microsoft Entra ID App Registration.
