...
description: "Enable your Java WebLogic webapp to sign users in, protect endpoints, call APIs with the Microsoft identity platform"
...
# Enable your Java WebLogic web app to sign in users and call APIs with the Microsoft identity platform
