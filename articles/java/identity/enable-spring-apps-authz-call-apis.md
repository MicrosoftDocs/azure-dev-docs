---
title: Enable your Java Spring Boot web app to sign in users and call Microsoft Graph API with the Microsoft Identity platform
...
# Enable your Java Spring Boot web app to sign in users and call Microsoft Graph API with the Microsoft Identity platform

This article shows you how to authenticate your Spring Boot web app to Azure Active Directory by using the MSAL client library for Java. Once authenticated, your target user ID (principal) will have the runtime security credentials to be fully authenticated (AuthN) against Azure Active Directory which will allow calls to the Microsoft Graph API.  

The [sample code snippets](https://github.com/Azure-Samples/ms-identity-msal-java-samples/tree/main/4.%20Spring%20Framework%20Web%20App%20Tutorial/2-Authorization-I/call-graph) are available in GitHub as runnable Java files.
...
![Overview](./media/identity-authorization-spring/identity5.png)
...
![Experience](./media/identity-authorization-spring/identity6.png)
