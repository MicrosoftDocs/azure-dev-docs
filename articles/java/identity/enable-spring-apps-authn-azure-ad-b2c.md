---
title: Enable your Java Spring Boot web app to sign in users on your Azure Active Directory B2C tenant with the Microsoft identity platform (Azure AD B2C)
titleSuffix: Azure Identity
description: Get started developing a Java application that works with Azure Identity. This How-to guide helps you set up a project. It authenticates and authorizes access to an Azure by using Azure Active Directory B2C. 
author: KarlErickson
ms.author: jujunio
...
This article shows you how to authenticate your Spring Boot web app to Azure Active Directory B2C by using the MSAL client library for Java. Once authenticated, your target user ID (principal) will have the runtime security credentials to be fully authenticated (AuthN) against Azure Active Directory B2C.  

The [sample code snippets](https://github.com/Azure-Samples/ms-identity-msal-java-samples/tree/main/4.%20Spring%20Framework%20Web%20App%20Tutorial/1-Authentication/sign-in-b2c) are available in GitHub as runnable Java files.
...
azure:
  activedirectory:
    b2c:
      base-uri: Enter_Your_Base_URI_Here
...
![Scenario](./media/identity-authentication-spring/identity3.png)
...
![Experience](./media/identity-authentication-spring/identity4.png)
