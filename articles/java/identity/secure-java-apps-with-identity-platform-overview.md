...
- [Secure your Java Quarkus app](/azure/developer/java/ee/quarkus-with-microsoft-entra-id?toc=/azure/developer/java/identity/toc.json&bc=/azure/developer/java/breadcrumb/toc.json)
