...
This article shows you how to authenticate your Spring Boot web app to Azure Active Directory by using the MSAL client library for Java. Once authenticated, your target user ID (principal) will have the runtime security credentials to be fully authenticated (AuthN) against Azure Active Directory.  

The [sample code snippets](https://github.com/Azure-Samples/ms-identity-msal-java-samples/tree/main/4.%20Spring%20Framework%20Web%20App%20Tutorial/1-Authentication/sign-in) are available in GitHub as runnable Java files.
...
### Register the web app (java-spring-webapp-auth)
...
![Scenario](./media/identity-authentication-spring/identity1.png)
...
![Experience](./media/identity-authentication-spring/identity2.png)
