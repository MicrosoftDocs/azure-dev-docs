---
title: Add authorization using app roles and roles claims to Java JBoss EAP Web app that signs-in users with the Microsoft identity platform
description: Shows you how to add authorization using app roles and roles claims to Java JBoss EAP Web app that signs-in users with the Microsoft identity platform.
...
# Add authorization using app roles and roles claims to Java JBoss EAP Web app that signs-in users with the Microsoft identity platform
