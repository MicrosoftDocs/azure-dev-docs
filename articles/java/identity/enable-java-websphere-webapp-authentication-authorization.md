...
description: "Enable your Java Websphere webapp to sign users in, protect endpoints, call APIs with the Microsoft identity platform"
...
# Enable your Java Websphere web app to sign in users and call APIs with the Microsoft identity platform
