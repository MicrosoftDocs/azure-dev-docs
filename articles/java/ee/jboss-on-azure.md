...
There are two hosting options for JBoss EAP on Azure: App Service and Virtual Machines & Virtual Machine Scale Sets. All solutions are jointly developed and supported by Red Hat and Azure.
