...
This article doesn't direct you to deploy your app on Azure. There are no resources to clean up for the app. To deploy an app on Azure, you can follow the guidance referenced in the next section.
