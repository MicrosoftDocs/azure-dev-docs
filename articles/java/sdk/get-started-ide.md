...
description: Install Azure extensions for IntelliJ and Eclipse to set up your Java development environment for Azure quickly. Follow these steps to get started today.
author: bmitchell287
ms.author: brendm
ms.reviewer: jogiles
ms.date: 07/27/2026
...
If you plan to deploy web apps or APIs programmatically, install the [Azure toolkit](../toolkit-for-intellij/index.yml). The toolkit also includes a comprehensive SDK reference book for any Azure development with Java SDK. For a quickstart with Azure Web Apps, see [Create a Hello World web app for Azure App Service using IntelliJ](../toolkit-for-intellij/create-hello-world-web-app.md).

The following steps summarize the installation process.

1. Select the **File** menu, and then select **Settings**.
1. Select **Browse repositories**, search for **Azure**, and install the **Azure toolkit for Intellij**.
1. Restart Intellij.
1. Open the reference book from **Tools -> Azure -> Azure SDK Reference Book**.

   :::image type="content" source="./media/azure-sdk-reference-book-intellij.png" alt-text="Screenshot of the Azure SDK Reference Book menu option in IntelliJ.":::

## Install the Azure Toolkit for Eclipse

If you plan to deploy web apps or APIs programmatically, install the [Azure toolkit](../toolkit-for-eclipse/index.yml). Currently, it isn't used for any other kinds of development. For a quickstart, see [Create a Hello World web app for Azure App Service using Eclipse](../toolkit-for-eclipse/create-hello-world-web-app.md).
