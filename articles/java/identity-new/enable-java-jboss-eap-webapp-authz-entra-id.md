...
description: "This sample demonstrates a Java Jboss EAP web app that signs in users and obtains an access token to call MS Graph with the Microsoft identity platform"
---

# Enable your Java Jboss EAP web app to sign in users and call Microsoft Graph with the Microsoft identity platform
