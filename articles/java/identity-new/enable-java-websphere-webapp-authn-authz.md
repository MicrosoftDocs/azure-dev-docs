...
- [Application and service principal objects in Entra ID](https://docs.microsoft.com/azure/active-directory/develop/app-objects-and-service-principals)
