...
description: "This sample demonstrates how to create a Java Tomcat web app that signs in users and restricts access to pages based on group membership with the Microsoft identity platform"
---
