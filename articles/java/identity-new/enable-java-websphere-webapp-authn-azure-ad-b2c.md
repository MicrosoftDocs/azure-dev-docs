...
description: "This sample demonstrates a Java Websphere webapp that signs in users with Azure AD B2C"
---

# Java Websphere Web App using MSAL4J to authenticate users into Azure Active Directory B2C
