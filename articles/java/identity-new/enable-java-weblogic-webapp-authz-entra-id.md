...
description: "This sample demonstrates a Java WebLogic web app that signs in users and obtains an access token to call MS Graph with the Microsoft identity platform"
---

# Enable your Java WebLogic web app to sign in users and call Microsoft Graph with the Microsoft identity platform
