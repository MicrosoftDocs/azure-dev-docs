...
description: "This sample demonstrates how to add authorization using app roles & roles claims to a Java Jboss EAP web app that signs-in users with the Microsoft identity platform"
---
