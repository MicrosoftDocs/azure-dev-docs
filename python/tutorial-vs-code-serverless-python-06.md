...
> [Next: Add a storage binding](tutorial-vs-code-serverless-python-07.md) [I ran into an issue](https://www.research.net/r/PWZWZ52?tutorial=python-functions-extension&step=06-second-function)
