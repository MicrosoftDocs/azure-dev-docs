...
[AP01]: ./media/deploy-spring-boot-java-app-with-maven-plugin/web-app-azure-app-services.png
[AP02]: ./media/deploy-spring-boot-java-app-with-maven-plugin/deployed-web-app-url-azure-app-services.png
